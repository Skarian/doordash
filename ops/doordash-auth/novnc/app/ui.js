...
* ------v------*/
    ...
    addTouchSpecificHandlers() {
        ...
        // Mobile login helper: a remote text field is only pixels inside the
        // VNC canvas, so browsers do not know to show their soft keyboard.
        // Treat a direct canvas tap as a user gesture that enables noVNC's
